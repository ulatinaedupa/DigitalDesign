...
HD_PWD='C:/Users/Isaias/Downloads/ShiftRegister/ShiftRegister.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegisterTestBench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShiftRegisterTestBench.tcl

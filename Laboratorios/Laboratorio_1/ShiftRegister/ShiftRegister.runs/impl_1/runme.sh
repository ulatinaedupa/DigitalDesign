...
HD_PWD='C:/Users/Isaias/Downloads/ShiftRegister/ShiftRegister.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegisterTestBench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ShiftRegisterTestBench.tcl -notrace
